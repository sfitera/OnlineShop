...
public class OnlineShopApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        List<Product> products = new ArrayList<>(List.of(
                new Product("Kniha", 15.00, 2, true, "img", Category.BIOGRAPHY, "Ferko", "Olala"),
                new Product( "Kniha2", 100.00, 0, false, "img",Category.BIOGRAPHY, "Ferko", "Olala"),
                new Product( "Kniha3", 35.00, 2, true, "img", Category.BIOGRAPHY, "Ferko", "Olala"),
                new Product( "Kniha4", 45.00, 4, false, "img", Category.BIOGRAPHY, "Ferko", "Olala"),
                new Product( "Kniha5", 20.00, 8, true, "img", Category.BIOGRAPHY, "Ferko", "Olala")
        ));
